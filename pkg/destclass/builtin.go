...
// ranges (IPv4 + IPv6). NOT exhaustive — production hosts should
// sync from authoritative sources (AWS ip-ranges.json, GCP
// cloud-ranges, Cloudflare ips-v4/ips-v6). The seeds cover the most
// common regions so testing works out of the box.
func defaultCloudCIDRs() []string {
	return []string{
		// AWS IPv4 — seed (real list is ~5000 CIDRs)
		...
		"2a01:111:f100::/64", // Azure EU IPv6
...
// defaultCDNCIDRs covers the major edge CDNs in IPv4 + IPv6.
func defaultCDNCIDRs() []string {
	return []string{
		// Cloudflare IPv4 (authoritative list at cloudflare.com/ips-v4)
		...
		// Cloudflare IPv6 (authoritative at cloudflare.com/ips-v6)
		...
		// Akamai IPv6
		"2600:1400::/24", "2600:1406::/24", "2600:140a::/24",
		"2600:1417::/24", "2600:141b::/24", "2600:141f::/24",
		// CloudFront (AWS) IPv4
		"54.182.0.0/16", "54.192.0.0/16", "54.230.0.0/16",
		"54.239.128.0/18", "143.204.0.0/16",
		// CloudFront IPv6
		"2600:9000::/28",
		// Google CDN / gstatic IPv6
		"2a00:1450::/29", "2607:f8b0::/32", "2620:0:1000::/40",
	}
}
